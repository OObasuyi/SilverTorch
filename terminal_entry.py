...
def terminal_entry():
    ...
    mandatory_args.add_argument(
        "-zolr", help="zone of last resort", required=True, type=str
    )
    ...
    optional_args.add_argument(
        "--same_creds", default=True, help="True or False/case-sensitive", type=bool
    )
    ...
    fm = AugmentedWorker(
        ...
        ippp_location=args.ippp_location,
        access_policy=args.access_policy,
        rule_prepend_name=args.rule_prepend_name,
        fmc_host=args.fmc_host,
        ftd_host=args.ftd_host,
        domain=args.domain,
        zbr_bypass=args.zbr_bypass,
        zone_of_last_resort=args.zolr,
        same_cred=args.same_creds,
    )
